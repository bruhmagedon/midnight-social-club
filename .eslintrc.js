module.exports = {
    ...
    rules: {
        ...
        'no-unused-vars': 'warn', // Отключает предупреждение о неиспользуемых переменных
        ...
        'react/jsx-props-no-spreading': 'warn', // Показывает предупреждение, если используется распространение пропсов (props spreading)
